...
mod tests {
    ...
    fn test_min_max_simd_without_x_parallel_correct() {
        ...
        let sampled_indices = min_max_simd_without_x_parallel(arr.view(), 10, half_n_threads);
        let sampled_values = sampled_indices.mapv(|x| arr[x]);
    ...
    fn test_min_max_simd_with_x_parallel_correct() {
        ...
        let sampled_indices =
            min_max_simd_with_x_parallel(x.view(), arr.view(), 10, half_n_threads);
        let sampled_values = sampled_indices.mapv(|x| arr[x]);
    ...
    fn test_many_random_runs_same_output() {
        ...
        for _ in 0..100 {
            ...
            let idxs2 = min_max_simd_without_x_parallel(arr.view(), n_out, half_n_threads);
            let idxs3 = min_max_simd_with_x(x.view(), arr.view(), n_out);
            let idxs4 = min_max_simd_with_x_parallel(x.view(), arr.view(), n_out, half_n_threads);
